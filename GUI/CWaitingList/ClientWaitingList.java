...
*/
public class ClientWaitingList implements Initializable {
	//Class variables *************************************************		
    ...
    private void loadOrder() {
    	...
    	if(ClientLogInController.objectType==ObjectKind.Member)
    		CostumerDetails.setText("Dear , " + ChatClient.member.getfirstName()+ " "+ChatClient.member.getlastName());
	    else  if(ClientLogInController.objectType==ObjectKind.Visitor)
    	CostumerDetails.setText("Dear , " + ChatClient.visitor.getfirstName()+ " "+ChatClient.visitor.getlastName());

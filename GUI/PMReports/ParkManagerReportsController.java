...
public class ParkManagerReportsController implements Initializable {
	...
	public static String park,monthName;
	...
	public static void setFlagCheckReport2(boolean flagCheckReport2) {
		ParkManagerReportsController.flagCheckReport2 = flagCheckReport2;
	}
	...
	public void getChart(ActionEvent event) throws Exception{
		stage.OpenStage(event, "/PMReportChart/ParkManagerChart","Park Manager Chart");
	}
	/**
	 * This method get the dates of report and set the visitors number reports details in the list view
	 * @param event
	 * @throws Exception
	 */ 
		...
		for(int i=0;i<reports.length;i++)
		{
			...
			if(reports[i].getMonth()==month&&reports[i].getYear()==year) 
			{
				...
				req.add(reports[i].toStringAsRow());		
